...
Este avatar aparte de un comportamiento deliberativo basado en el algoritmo A*
debía ser capaz de esquivar a los enemigos mediante un comportamiento reactivo.
